window.addEventListener("load", function(event) {
    ...
    function init() {
        ...
        animationCanvas.addEventListener("touchstart", touchstartHandler, false);
        animationCanvas.addEventListener("touchend", touchendHandler, false);
        animationCanvas.addEventListener("touchmove", touchmoveHandler, false);
    }
    ...
    function drawPaintingElements() {
        ...
        if(!isMobile) {
            animationCanvas.width = 800;
            animationCanvas.height = 450;
        ...
        if(!isMobile) {
            ...
            var dogPosX = 30,
                dogPosY = 320,
                dogImage = paintingElementCollection["dog"];
            animationContext.save();
            animationContext.transform(1,0,0,1,0,0);
    ...
    function touchmoveImage(touch) {
        ...
        var imageNewPosX = touch.pageX - animationCanvas.offsetLeft - 150/2; // 150은 사과나무 가로 크기
        var imageNewPosY = touch.pageY- animationCanvas.offsetTop - 215/2; // 215는 사과나무 세로 크기

        appleTreePosX = imageNewPosX;
        appleTreePosY = imageNewPosY;

        console.log("[사과나무] imageNewPosX: " + imageNewPosX + " / imageNewPosY: " + imageNewPosY);
    }
