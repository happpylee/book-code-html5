...
//    canvasDiv3.style.top = 8 + "px";
    canvasDiv3.style.width = imageDataPadSize * 2 + "px";
    canvasDiv3.style.height = imageDataPadSize * 2 + "px";
    ...
    canvasElement3.width = imageDataPadSize * 2;
    canvasElement3.height = imageDataPadSize * 2;
...
//    videoDiv.setAttribute("style", "display:none;")
    ...
    if(videoFormat == "") {
        ...
        videoSource.src = "res/video/sample_720_480." + videoFormat;
...
//        context.drawImage(videoElement, 0, 0, 1280, 720, 0, 0, 480, 270);
        context.drawImage(videoElement, 0, 0, 720, 480, 0, 0, 480, 270);
...
//        canvasDiv3.style.left = canvasElement.offsetLeft + event.clientX - transWidth + "px"; // mouseX - (imageDataPadSize / 2) + "px";
//        canvasDiv3.style.top = mouseY - (imageDataPadSize / 2) + "px";
//        canvasDiv3.style.left = event.clientX /*- transWidth*/ + "px"; // mouseX - (imageDataPadSize / 2) + "px";
//        canvasDiv3.style.top = event.clientY + "px"; // mouseX - (imageDataPadSize / 2) + "px";
